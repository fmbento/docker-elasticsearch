...
wget -q https://download.elasticsearch.org/elasticsearch/elasticsearch/elasticsearch-1.3.0.tar.gz -O /tmp/es.tgz
tar -xzf /tmp/es.tgz -C /opt/
mv /opt/elasticsearch-1.3.0 /opt/elasticsearch
